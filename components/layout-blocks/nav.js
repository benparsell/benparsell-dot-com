    ...
    return (
        ...
        <nav className='flex items-center flex-wrap bg-white p-3 '>
            ...
            <a className='inline-flex items-center p-2 mr-4 '>
                <img className={styles.logo} src="/images/ben-logo-black.png" />
            </a>
            </Link>
            <button
                ...
                >
                <div className='menu lg:inline-flex lg:flex-row lg:ml-auto lg:w-auto w-full lg:items-center items-start  flex flex-col lg:h-auto'>
                    <Link href='/'>
